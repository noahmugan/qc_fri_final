...
class Classifier:
    ...
    def classify(self, test_vec: Union[list, np.ndarray], show_circuit: bool = False)-> str:
        ...
        for cl, vec in self.train_vecs.items():
            if max_inner is None:
                ...
                inner_product = series_inner_product(v_1 = vec, v_2 = test_vec)
                if inner_product > max_inner[1]:
